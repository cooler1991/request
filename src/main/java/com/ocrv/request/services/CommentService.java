...
public class CommentService {
    ...
    public CommentService(CommentRepository commentRepository, CommentConverter commentConverter, RequestRepository requestRepository) {
 ...
 /*   public CommentDto save(CommentDto commentDto) {
    ...
    public CommentDto add(int id, CommentDto commentDto) {
